...
void test_xnavi_adapter() {
    ...
    assert(daq_capability_test::select_xnavi_supported_voltage_range("-10V~10V", supported_ranges, selected_range));
    assert(selected_range == 0);
    assert(!daq_capability_test::select_xnavi_supported_voltage_range("-5V~5V", supported_ranges, selected_range));
    assert(!daq_capability_test::select_xnavi_supported_voltage_range("5V", supported_ranges, selected_range));
    assert(!daq_capability_test::select_xnavi_supported_voltage_range("-10~10", supported_ranges, selected_range));
    ...
    const std::vector<std::vector<double>> output = daq_capability_test::deinterleave_xnavi_samples(input, 2);
