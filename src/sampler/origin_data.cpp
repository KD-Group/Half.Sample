...
void reset_loaded_result(Result::SamplingResult& result, const Config::SamplingConfig& config) {
    ...
    result.requested_waveforms = 0;
    result.complete_waveforms = 0;
    result.discarded_waveforms = 0;
    result.independent_batches = 0;
    result.independent_retries = 0;
    result.rejected_threshold_candidates = 0;
    result.rejected_short_periods = 0;
    result.rejected_long_periods = 0;
    result.rejected_amplitude_cycles = 0;
    result.rejected_baseline_cycles = 0;
    result.rejected_shape_cycles = 0;
    result.independent_cycle_accumulator.clear();
    result.independent_cycle_maximum_accumulator.clear();
    result.independent_cycle_minimum_accumulator.clear();
