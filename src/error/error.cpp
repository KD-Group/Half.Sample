...
std::string to_string(Code error_code) {
    ...
    case INVALID_INSTANT_AI_CONFIG:
        return "invalid_instant_ai_config";
    case INSTANT_AI_COVERAGE_INSUFFICIENT:
        return "instant_ai_coverage_insufficient";
    case INSTANT_AI_SCHEDULE_TIMEOUT:
        return "instant_ai_schedule_timeout";
    ...
    case SAMPLING_RESULT_NOT_FINITE:
        return "sampling_result_not_finite";
    case USER_CANCELLED:
