...
#define MAX_EDEG_NAME_LEN     256
#define MAX_EDEG_ACCESS_LEN   256
...
typedef enum AiChannelState {
   ACSNormal = 0, 
   ACSOpen,      /* Sensor is in open-circuit state */
   ACSShort,     /* Sensor is in short-circuit state */
} AiChannelState;
...
typedef enum ErrorCode {
   ...
   /// <summary>
   /// The Scale Table is not suitable for the final engineering unit
   ///
   /// </summary>
   WarningScaleTableNotFinal =  0xA000000E,
   ...
   //Edge isn't ready, one service exe and dll exist, but can't be started.
   ErrorEthOneServiceStartedFailed  = 0xE000002A,

   //Edge isn't ready, one service exe and dll don't exist.
   ErrorEthOneServiceFilesNotExisted = 0xE000002B,

   /// <summary>
   /// The specified managed edge was not found. 
   /// </summary>
   ErrorEdgeNotFound = 0xE000002C,

   /// <summary>
   /// The managed edge count exceeded the limitation. 
   /// </summary>
   ErrorEdgeCountExceedLimit = 0xE000002D,

   /// <summary>
   /// Save the device's properties in Ini file failed. 
   /// </summary>
   ErrorSaveIniFileFailed = 0xE000002E,

   /// <summary>
   /// The host failed to configure the required settings.
   /// </summary>
   ErrorHostConfigFailed = 0xE000002F,

   /// <summary>
   /// The coprocessor failed to configure the required settings.
   /// </summary>
   ErrorCoprocessorConfigFailed = 0xE0000030,
...
typedef enum ProductId {
   ...
   BD_USBDSW01   = 0x879, // ACG ODM Device base on USB-4750-C
...
typedef enum BufDataTransType {
   ...
   /*----------------------------------------------------------------------*/
   /*Dummy ID, to ensure the type is compiled as 'int' by various compiler */
   BufDataTransTypeUnknown = 0xffffffff,
} BufDataTransType;

typedef enum DsDataPermutation {
   OrderByTime = 0,
   OrderByChl,

   /*----------------------------------------------------------------------*/
   /*Dummy ID, to ensure the type is compiled as 'int' by various compiler */
   DsDataPermutationUnknown = 0xffffffff,
} DsDataPermutation;

typedef enum DsProcessedType {
   DptRaw = 0,
   DptScaledFloat,
   DptScaledDouble,
   DptNormInt16,
   ...
   /*----------------------------------------------------------------------*/
   /*Dummy ID, to ensure the type is compiled as 'int' by various compiler */
   DsProcessedTypeUnknown = 0xffffffff,
} DsProcessedType;

typedef enum DsSignal {
   DsInactive = 0,
   DsNormal,
   AcfRecordEnd = 0x100,
   AcfDsCacheXrun,
   ...
   /*----------------------------------------------------------------------*/
   /*Dummy ID, to ensure the type is compiled as 'int' by various compiler */
   DsSignalUnknown = 0xffffffff,
} DsSignal;

typedef enum BurnoutRetType ErrorRetType;

/* ----------------------------------------------------------
* Event monitor thread priority, especially for DI Events   *
* ----------------------------------------------------------*/
#define EMT_PRIO_NORMAL          0
#define EMT_PRIO_HIGH            1
#define EMT_PRIO_RT              2
...
typedef struct EthManagedEdge
{
   wchar_t    EdgeName[MAX_EDEG_NAME_LEN];
   wchar_t    EdgeAccount[MAX_EDEG_ACCESS_LEN];
   wchar_t    EdgeAccess[MAX_EDEG_ACCESS_LEN];
}EthManagedEdge;
...
typedef struct CaliSectionInParam        CaliSectionInParam;
...
#define DAQFN_GBL_TTTTTTTT(Apis, n, rt, t1, t2, t3, t4, t5, t6, t7) ((rt        (BDAQCALL *)(t1, t2, t3, t4, t5, t6, t7))Apis[n])
#define DAQFN_GBL_ET(Apis, n, t1)                                   ((ErrorCode (BDAQCALL *)(t1))Apis[n])
#define DAQFN_GBL_ETT(Apis, n, t1, t2)                              ((ErrorCode (BDAQCALL *)(t1, t2))Apis[n])
...
BDAQINL ErrorCode AdxFusionDeviceLogin(wchar_t const * srvName, wchar_t const * account, wchar_t const * password, int32 timeout, int32* edgeHandle)
{
   DNL_Initialize(); 
   return DAQFN_GBL_ETTTTT(DNLAPI_GBL, 15, wchar_t const *, wchar_t const *, wchar_t const *, int32, int32*)(srvName, account, password, timeout, edgeHandle);
}
...
BDAQINL ErrorCode AdxFusionDeviceCreateEx(int32 edgeHandle, int32 count, int32 children[], int32 *fusionNumber)
{  
   DNL_Initialize(); 
   return DAQFN_GBL_ETTTT(DNLAPI_GBL, 17, int32, int32, int32 *, int32 *)(edgeHandle, count, children, fusionNumber);
}

BDAQINL ErrorCode AdxFusionDeviceAddChildrenEx(int32 edgeHandle, int32 fusionNumber, int32 count, int32 children[])
{  
   DNL_Initialize(); 
   return DAQFN_GBL_ETTTT(DNLAPI_GBL, 18, int32, int32, int32, int32 *)(edgeHandle, fusionNumber, count, children);
}

BDAQINL ErrorCode AdxFusionDeviceDeleteChildrenEx(int32 edgeHandle,int32 fusionNumber, int32 count, int32 children[])
{  
   DNL_Initialize(); 
   return DAQFN_GBL_ETTTT(DNLAPI_GBL, 19, int32, int32, int32, int32 *)(edgeHandle, fusionNumber, count, children);
}

BDAQINL ErrorCode AdxFusionDeviceGetChildrenEx(int32 edgeHandle, int32 fusionNumber, int32 *count, int32 children[])
{  
   DNL_Initialize(); 
   return DAQFN_GBL_ETTTT(DNLAPI_GBL, 20, int32, int32, int32 *, int32 *)(edgeHandle, fusionNumber, count, children);
}

BDAQINL ErrorCode AdxDeviceFusionableCheckEx(int32 edgeHandle, int32 fusionNumber, int32 count, int32 children[])
{  
   DNL_Initialize(); 
   return DAQFN_GBL_ETTTT(DNLAPI_GBL, 21, int32, int32, int32, int32 *)(edgeHandle, fusionNumber, count, children);
}

BDAQINL ErrorCode AdxIsFusionDeviceEx(int32 edgeHandle, int32 fusionNumber)
{  
   DNL_Initialize(); 
   return DAQFN_GBL_ETT(DNLAPI_GBL, 22, int32, int32)(edgeHandle, fusionNumber);
}

BDAQINL ErrorCode AdxFusionDeviceLogout(int32 edgeHandle)
{
   DNL_Initialize(); 
   return DAQFN_GBL_ET(DNLAPI_GBL, 16, int32)(edgeHandle);
}

BDAQINL ErrorCode AdxQueryActiveManagedEdge(int32* count, EthManagedEdge* edges)
{
   DNL_Initialize();
   return DAQFN_GBL_ETT(DNLAPI_GBL, 23, int32*, EthManagedEdge*)(count, edges);
}
...
BDAQINL ErrorCode         DeviceCtrl_getLEDConfig(DeviceCtrl *obj, int32 length, uint8 cfg[])                                            { return DAQFN_ETT(DNLAPI_BASE, 157, int32, uint8 *)(obj, length, cfg); }
BDAQINL ErrorCode         DeviceCtrl_setLEDConfig(DeviceCtrl *obj, int32 length, uint8 cfg[])                                            { return DAQFN_ETT(DNLAPI_BASE, 158, int32, uint8 *)(obj, length, cfg); }
BDAQINL ErrorCode         DeviceCtrl_getLEDOutput(DeviceCtrl *obj, int32 length, uint8 sta[])                                            { return DAQFN_ETT(DNLAPI_BASE, 159, int32, uint8 *)(obj, length, sta); }
BDAQINL ErrorCode         DeviceCtrl_setLEDOutput(DeviceCtrl *obj, int32 length, uint8 sta[])                                            { return DAQFN_ETT(DNLAPI_BASE, 160, int32, uint8 *)(obj, length, sta); }
...
BDAQINL DeviceCtrl *      DeviceCtrl_CreateEx(int32 devNumber, wchar_t const *desc, AccessMode mode, wchar_t const *srvName, wchar_t const *account,wchar_t const *password, int32 timeout) { DNL_Initialize(); return DAQFN_GBL_TTTTTTTT(DNLAPI_BASE, 154, DeviceCtrl *, int32, wchar_t const *, AccessMode, wchar_t const *, wchar_t const *, wchar_t const *, int32)(devNumber, desc, mode, srvName, account, password, timeout); }
...
BDAQINL ErrorCode         DaqCtrlBase_Login(DaqCtrlBase *obj, wchar_t const *srvName)                                                                   { return DAQFN_ETTTT(DNLAPI_BASE, 152, wchar_t const *, wchar_t const *, wchar_t const *, int32)(obj, srvName, L"", L"", 3000); }
BDAQINL ErrorCode         DaqCtrlBase_LoginEx(DaqCtrlBase *obj, wchar_t const *srvName, wchar_t const *account, wchar_t const *password, int32 timeout) { return DAQFN_ETTTT(DNLAPI_BASE, 152, wchar_t const *, wchar_t const *, wchar_t const *, int32)(obj, srvName, account, password, timeout); }
BDAQINL ErrorCode         DaqCtrlBase_getEthdaqEdge(DaqCtrlBase *obj, int32 size, wchar_t* srvName)                                      { return DAQFN_ETT(DNLAPI_BASE, 155, int32, wchar_t*)(obj, size, srvName); }

/*New: methods for property read/write directly.*/
BDAQINL ErrorCode         DaqCtrlBase_ReadProperty(DaqCtrlBase *obj, int32 id, int32 *size, void *buffer)                                { return DAQFN_ETTT(DNLAPI_BASE, 172, int32, int32 *, void *)(obj, id, size, buffer); }
BDAQINL ErrorCode         DaqCtrlBase_WriteProperty(DaqCtrlBase *obj, int32 id, int32 size, void *buffer)                                { return DAQFN_ETTT(DNLAPI_BASE, 173, int32, int32,   void *)(obj, id, size, buffer); }

/*Event Monitor Thread Priority Management*/
BDAQINL int32             DaqCtrlBase_AdjustPriority(DaqCtrlBase *obj, int32 priority)                                                   { return DAQFN_TT(DNLAPI_BASE, 156, int32, int32)(obj, priority);}
...
BDAQINL ErrorCode         InstantAiCtrl_runSensorCalibration(InstantAiCtrl *obj, int32 ch, CalibrationData *data)                         { return DAQFN_ETT(DNLAPI_AI, 111, int32, CalibrationData *)(obj, ch, data);   }
BDAQINL ErrorCode         InstantAiCtrl_getChannelState(InstantAiCtrl *obj, int32 count, int32 state[])                                   { return DAQFN_ETT(DNLAPI_AI, 123, int32, int32 *)(obj, count, state);   }
...
BDAQINL ErrorCode         InstantAiCtrl_ReadAnyWithTimestamp(InstantAiCtrl *obj, int32 chStart, int32 chCount, void *dataRaw, double *dataScaled, double *timestamp) { return DAQFN_ETTTTT(DNLAPI_AI, 122, int32, int32, void *, double *, double *)(obj, chStart, chCount, dataRaw, dataScaled, timestamp); }
...
BDAQINL ErrorCode         InstantAiCtrl_Login(InstantAiCtrl *obj, wchar_t const *srvName)                                                                   { return DAQFN_ETTTT(DNLAPI_BASE, 152, wchar_t const *, wchar_t const *, wchar_t const *, int32)(obj, srvName, L"", L"", 3000); }
BDAQINL ErrorCode         InstantAiCtrl_LoginEx(InstantAiCtrl *obj, wchar_t const *srvName, wchar_t const *account, wchar_t const *password, int32 timeout) { return DAQFN_ETTTT(DNLAPI_BASE, 152, wchar_t const *, wchar_t const *, wchar_t const *, int32)(obj, srvName, account, password, timeout); }
BDAQINL ErrorCode         InstantAiCtrl_Logout(InstantAiCtrl *obj)                                                                                          { return DAQFN_EV(DNLAPI_BASE, 153)(obj);                                                                                              }
...
BDAQINL ErrorCode         BufferedAiCtrl_runSensorCalibration(BufferedAiCtrl *obj, int32 ch, CalibrationData *data)                       { return DAQFN_ETT(DNLAPI_AI, 111, int32, CalibrationData *)(obj, ch, data);  }
BDAQINL ErrorCode         BufferedAiCtrl_getChannelState(BufferedAiCtrl *obj, int32 count, int32 state[])                                 { return DAQFN_ETT(DNLAPI_AI, 123, int32, int32 *)(obj, count, state);   }
...
BDAQINL ErrorCode         BufferedAiCtrl_Login(BufferedAiCtrl *obj, wchar_t const *srvName)                                                                 { return DAQFN_ETTTT(DNLAPI_BASE, 152, wchar_t const *, wchar_t const *, wchar_t const *, int32)(obj, srvName, L"", L"", 3000); }
BDAQINL ErrorCode         BufferedAiCtrl_LoginEx(BufferedAiCtrl *obj, wchar_t const *srvName, wchar_t const *account, wchar_t const *password, int32 timeout) { return DAQFN_ETTTT(DNLAPI_BASE, 152, wchar_t const *, wchar_t const *, wchar_t const *, int32)(obj, srvName, account, password, timeout); }
BDAQINL ErrorCode         BufferedAiCtrl_Logout(BufferedAiCtrl *obj)                                                                                        { return DAQFN_EV(DNLAPI_BASE, 153)(obj);                                                                                              }
...
BDAQINL ErrorCode         WaveformAiCtrl_runSensorCalibration(WaveformAiCtrl *obj, int32 ch, CalibrationData *data)                       { return DAQFN_ETT(DNLAPI_AI, 111, int32, CalibrationData *)(obj, ch, data);  }
BDAQINL ErrorCode         WaveformAiCtrl_getChannelState(WaveformAiCtrl *obj, int32 count, int32 state[])                                 { return DAQFN_ETT(DNLAPI_AI, 123, int32, int32 *)(obj, count, state);   }
...
BDAQINL ErrorCode WaveformAiCtrl_GetSliceData(WaveformAiCtrl *obj, void *buf, int32 timeout, int32 *fetched, double *startTime, DsSignal *dsSignal, void *stream)
{
   typedef ErrorCode (BDAQCALL *FNGETSLICEDATA)(void *, void *, int32, int32 *, double *, DsSignal *, void *);
   return ((FNGETSLICEDATA)DNLAPI_AI[130])(obj, buf, timeout, fetched, startTime, dsSignal, stream);
}
...
BDAQINL BufDataTransType  WaveformAiCtrl_getDtcTransType(WaveformAiCtrl *obj)                                                             { return DAQFN_TV(DNLAPI_AI, 124, BufDataTransType)(obj);       }
BDAQINL ErrorCode         WaveformAiCtrl_setDtcTransType(WaveformAiCtrl *obj, BufDataTransType type)                                      { return DAQFN_ET(DNLAPI_AI, 125, BufDataTransType)(obj, type); }
BDAQINL DsProcessedType   WaveformAiCtrl_getConvDataType(WaveformAiCtrl *obj)                                                             { return DAQFN_TV(DNLAPI_AI, 126, DsProcessedType)(obj);        }
BDAQINL ErrorCode         WaveformAiCtrl_setConvDataType(WaveformAiCtrl *obj, DsProcessedType type)                                       { return DAQFN_ET(DNLAPI_AI, 127, DsProcessedType)(obj, type);  }
BDAQINL DsDataPermutation WaveformAiCtrl_getConvPermutation(WaveformAiCtrl *obj)                                                          { return DAQFN_TV(DNLAPI_AI, 128, DsDataPermutation)(obj);      }
BDAQINL ErrorCode         WaveformAiCtrl_setConvPermutation(WaveformAiCtrl *obj, DsDataPermutation type)                                  { return DAQFN_ET(DNLAPI_AI, 129, DsDataPermutation)(obj, type);}

BDAQINL ErrorCode         WaveformAiCtrl_Login(WaveformAiCtrl *obj, wchar_t const *srvName)                                                                   { return DAQFN_ETTTT(DNLAPI_BASE, 152, wchar_t const *, wchar_t const *, wchar_t const *, int32)(obj, srvName, L"", L"", 3000); }
BDAQINL ErrorCode         WaveformAiCtrl_LoginEx(WaveformAiCtrl *obj, wchar_t const *srvName, wchar_t const *account, wchar_t const *password, int32 timeout) { return DAQFN_ETTTT(DNLAPI_BASE, 152, wchar_t const *, wchar_t const *, wchar_t const *, int32)(obj, srvName, account, password, timeout); }
BDAQINL ErrorCode         WaveformAiCtrl_Logout(WaveformAiCtrl *obj)                                                                                          { return DAQFN_EV(DNLAPI_BASE, 153)(obj);                                                                                              }
...
BDAQINL ErrorCode         InstantAoCtrl_Login(InstantAoCtrl *obj, wchar_t const *srvName)                                                                 { return DAQFN_ETTTT(DNLAPI_BASE, 152, wchar_t const *, wchar_t const *, wchar_t const *, int32)(obj, srvName, L"", L"", 3000); }
BDAQINL ErrorCode         InstantAoCtrl_LoginEx(InstantAoCtrl *obj, wchar_t const *srvName, wchar_t const *account, wchar_t const *password, int32 timeout) { return DAQFN_ETTTT(DNLAPI_BASE, 152, wchar_t const *, wchar_t const *, wchar_t const *, int32)(obj, srvName, account, password, timeout); }
BDAQINL ErrorCode         InstantAoCtrl_Logout(InstantAoCtrl *obj)                                                                                        { return DAQFN_EV(DNLAPI_BASE, 153)(obj);                                                                                              }
...
BDAQINL ErrorCode         BufferedAoCtrl_Login(BufferedAoCtrl *obj, wchar_t const *srvName)                                                                 { return DAQFN_ETTTT(DNLAPI_BASE, 152, wchar_t const *, wchar_t const *, wchar_t const *, int32)(obj, srvName, L"", L"", 3000); }
BDAQINL ErrorCode         BufferedAoCtrl_LoginEx(BufferedAoCtrl *obj, wchar_t const *srvName, wchar_t const *account, wchar_t const *password, int32 timeout) { return DAQFN_ETTTT(DNLAPI_BASE, 152, wchar_t const *, wchar_t const *, wchar_t const *, int32)(obj, srvName, account, password, timeout); }
BDAQINL ErrorCode         BufferedAoCtrl_Logout(BufferedAoCtrl *obj)                                                                                        { return DAQFN_EV(DNLAPI_BASE, 153)(obj);                                                                                              }
...
BDAQINL ErrorCode         InstantDiCtrl_ReadAnyWithTimestamp(InstantDiCtrl *obj, int32 portStart, int32 portCount, uint8 data[], double *timestamp) { return DAQFN_ETTTT(DNLAPI_DIO, 135, int32, int32, uint8 *, double *)(obj, portStart, portCount, data, timestamp);}
BDAQINL ErrorCode         InstantDiCtrl_ReadBitWithTimestamp(InstantDiCtrl *obj, int32 port, int32 bit, uint8* data, double *timestamp)             { return DAQFN_ETTTT(DNLAPI_DIO, 136, int32, int32, uint8 *, double *)(obj, port, bit, data, timestamp);           }
...
BDAQINL ErrorCode         InstantDiCtrl_Login(InstantDiCtrl *obj, wchar_t const *srvName)                                                                 { return DAQFN_ETTTT(DNLAPI_BASE, 152, wchar_t const *, wchar_t const *, wchar_t const *, int32)(obj, srvName, L"", L"", 3000); }
BDAQINL ErrorCode         InstantDiCtrl_LoginEx(InstantDiCtrl *obj, wchar_t const *srvName, wchar_t const *account, wchar_t const *password, int32 timeout) { return DAQFN_ETTTT(DNLAPI_BASE, 152, wchar_t const *, wchar_t const *, wchar_t const *, int32)(obj, srvName, account, password, timeout); }
BDAQINL ErrorCode         InstantDiCtrl_Logout(InstantDiCtrl *obj)                                                                                        { return DAQFN_EV(DNLAPI_BASE, 153)(obj);                                                                                              }

/* New SnapStart method: specify the ports to be snapped */
BDAQINL ErrorCode         InstantDiCtrl_SnapStartEx(InstantDiCtrl *obj, int32 portStart, int32 portCount)                               { return DAQFN_ETT(DNLAPI_DIO, 137, int32, int32)(obj, portStart, portCount); }
...
BDAQINL ErrorCode         BufferedDiCtrl_Login(BufferedDiCtrl *obj, wchar_t const *srvName)                                                                 { return DAQFN_ETTTT(DNLAPI_BASE, 152, wchar_t const *, wchar_t const *, wchar_t const *, int32)(obj, srvName, L"", L"", 3000); }
BDAQINL ErrorCode         BufferedDiCtrl_LoginEx(BufferedDiCtrl *obj, wchar_t const *srvName, wchar_t const *account, wchar_t const *password, int32 timeout) { return DAQFN_ETTTT(DNLAPI_BASE, 152, wchar_t const *, wchar_t const *, wchar_t const *, int32)(obj, srvName, account, password, timeout); }
BDAQINL ErrorCode         BufferedDiCtrl_Logout(BufferedDiCtrl *obj)                                                                                        { return DAQFN_EV(DNLAPI_BASE, 153)(obj);                                                                                              }
...
BDAQINL ErrorCode         InstantDoCtrl_Login(InstantDoCtrl *obj, wchar_t const *srvName)                                                                 { return DAQFN_ETTTT(DNLAPI_BASE, 152, wchar_t const *, wchar_t const *, wchar_t const *, int32)(obj, srvName, L"", L"", 3000); }
BDAQINL ErrorCode         InstantDoCtrl_LoginEx(InstantDoCtrl *obj, wchar_t const *srvName, wchar_t const *account, wchar_t const *password, int32 timeout) { return DAQFN_ETTTT(DNLAPI_BASE, 152, wchar_t const *, wchar_t const *, wchar_t const *, int32)(obj, srvName, account, password, timeout); }
BDAQINL ErrorCode         InstantDoCtrl_Logout(InstantDoCtrl *obj)                                                                                        { return DAQFN_EV(DNLAPI_BASE, 153)(obj);                                                                                              }
...
BDAQINL ErrorCode         BufferedDoCtrl_Login(BufferedDoCtrl *obj, wchar_t const *srvName) { return DAQFN_ETTTT(DNLAPI_BASE, 152, wchar_t const *, wchar_t const *, wchar_t const *, int32)(obj, srvName, L"", L"", 3000); }
BDAQINL ErrorCode         BufferedDoCtrl_LoginEx(BufferedDoCtrl *obj, wchar_t const *srvName, wchar_t const *account, wchar_t const *password, int32 timeout) { return DAQFN_ETTTT(DNLAPI_BASE, 152, wchar_t const *, wchar_t const *, wchar_t const *, int32)(obj, srvName, account, password, timeout); }
BDAQINL ErrorCode         BufferedDoCtrl_Logout(BufferedDoCtrl *obj)                                                                                   { return DAQFN_EV(DNLAPI_BASE, 153)(obj);                                                                                              }
...
BDAQINL IArray *          CntrFeatures_getTriggerSources(CntrFeatures *obj, int trigger)                                                { return DAQFN_TT(DNLAPI_CNTR, 133, IArray *, int32)(obj, trigger); }
BDAQINL IArray *          CntrFeatures_getTriggerActions(CntrFeatures *obj, int trigger)                                                { return DAQFN_TT(DNLAPI_CNTR, 134, IArray *, int32)(obj, trigger); }
BDAQINL void              CntrFeatures_getTriggerDelayRange(CntrFeatures *obj, int trigger, MathInterval *x)                            {        DAQFN_VTT(DNLAPI_CNTR, 274, int32, MathInterval *)(obj, trigger, x); }
...
BDAQINL void              CntrFeatures_getSampleClockRange(CntrFeatures *obj, MathInterval *x)                                          {        DAQFN_VT(DNLAPI_CNTR, 265, MathInterval *)(obj, x);  }
...
BDAQINL ErrorCode         EventCounterCtrl_Login(EventCounterCtrl *obj, wchar_t const *srvName)                                                                   { return DAQFN_ETTTT(DNLAPI_BASE, 152, wchar_t const *, wchar_t const *, wchar_t const *, int32)(obj, srvName, L"", L"", 3000); }
BDAQINL ErrorCode         EventCounterCtrl_LoginEx(EventCounterCtrl *obj, wchar_t const *srvName, wchar_t const *account, wchar_t const *password, int32 timeout) { return DAQFN_ETTTT(DNLAPI_BASE, 152, wchar_t const *, wchar_t const *, wchar_t const *, int32)(obj, srvName, account, password, timeout); }
BDAQINL ErrorCode         EventCounterCtrl_Logout(EventCounterCtrl *obj)                                                                                          { return DAQFN_EV(DNLAPI_BASE, 153)(obj);                                                                                              }
...
BDAQINL Trigger*          BufferedEventCounterCtrl_getTrigger(BufferedEventCounterCtrl *obj, int32 trigger)                                             { return DAQFN_TT(DNLAPI_CNTR,  141, Trigger *, int32)(obj, trigger); }
...
BDAQINL ErrorCode         BufferedEventCounterCtrl_setSampleClkRate(BufferedEventCounterCtrl *obj, double rate)                                         { return DAQFN_ET(DNLAPI_CNTR,  266, double)(obj, rate);        }
BDAQINL double            BufferedEventCounterCtrl_getSampleClkRate(BufferedEventCounterCtrl *obj)                                                      { return DAQFN_TV(DNLAPI_CNTR,  267, double)(obj);              }
...
BDAQINL ErrorCode         BufferedEventCounterCtrl_Login(BufferedEventCounterCtrl *obj, wchar_t const *srvName)                                                                   { return DAQFN_ETTTT(DNLAPI_BASE, 152, wchar_t const *, wchar_t const *, wchar_t const *, int32)(obj, srvName, L"", L"", 3000); }
BDAQINL ErrorCode         BufferedEventCounterCtrl_LoginEx(BufferedEventCounterCtrl *obj, wchar_t const *srvName, wchar_t const *account, wchar_t const *password, int32 timeout) { return DAQFN_ETTTT(DNLAPI_BASE, 152, wchar_t const *, wchar_t const *, wchar_t const *, int32)(obj, srvName, account, password, timeout); }
BDAQINL ErrorCode         BufferedEventCounterCtrl_Logout(BufferedEventCounterCtrl *obj)                                                                                          { return DAQFN_EV(DNLAPI_BASE, 153)(obj);                                                                                              }
...
BDAQINL ErrorCode         FreqMeterCtrl_Login(FreqMeterCtrl *obj, wchar_t const *srvName)                                                                 { return DAQFN_ETTTT(DNLAPI_BASE, 152, wchar_t const *, wchar_t const *, wchar_t const *, int32)(obj, srvName, L"", L"", 3000); }
BDAQINL ErrorCode         FreqMeterCtrl_LoginEx(FreqMeterCtrl *obj, wchar_t const *srvName, wchar_t const *account, wchar_t const *password, int32 timeout) { return DAQFN_ETTTT(DNLAPI_BASE, 152, wchar_t const *, wchar_t const *, wchar_t const *, int32)(obj, srvName, account, password, timeout); }
BDAQINL ErrorCode         FreqMeterCtrl_Logout(FreqMeterCtrl *obj)                                                                                        { return DAQFN_EV(DNLAPI_BASE, 153)(obj);                                                                                              }
...
BDAQINL ErrorCode         OneShotCtrl_Login(OneShotCtrl *obj, wchar_t const *srvName)                                                                 { return DAQFN_ETTTT(DNLAPI_BASE, 152, wchar_t const *, wchar_t const *, wchar_t const *, int32)(obj, srvName, L"", L"", 3000); }
BDAQINL ErrorCode         OneShotCtrl_LoginEx(OneShotCtrl *obj, wchar_t const *srvName, wchar_t const *account, wchar_t const *password, int32 timeout) { return DAQFN_ETTTT(DNLAPI_BASE, 152, wchar_t const *, wchar_t const *, wchar_t const *, int32)(obj, srvName, account, password, timeout); }
BDAQINL ErrorCode         OneShotCtrl_Logout(OneShotCtrl *obj)                                                                                        { return DAQFN_EV(DNLAPI_BASE, 153)(obj);                                                                                              }
...
BDAQINL ErrorCode         TimerPulseCtrl_Login(TimerPulseCtrl *obj, wchar_t const *srvName)                                                                 { return DAQFN_ETTTT(DNLAPI_BASE, 152, wchar_t const *, wchar_t const *, wchar_t const *, int32)(obj, srvName, L"", L"", 3000); }
BDAQINL ErrorCode         TimerPulseCtrl_LoginEx(TimerPulseCtrl *obj, wchar_t const *srvName, wchar_t const *account, wchar_t const *password, int32 timeout) { return DAQFN_ETTTT(DNLAPI_BASE, 152, wchar_t const *, wchar_t const *, wchar_t const *, int32)(obj, srvName, account, password, timeout); }
BDAQINL ErrorCode         TimerPulseCtrl_Logout(TimerPulseCtrl *obj)                                                                                        { return DAQFN_EV(DNLAPI_BASE, 153)(obj);                                                                                              }
...
BDAQINL ErrorCode         PwMeterCtrl_Login(PwMeterCtrl *obj, wchar_t const *srvName)                                                                   { return DAQFN_ETTTT(DNLAPI_BASE, 152, wchar_t const *, wchar_t const *, wchar_t const *, int32)(obj, srvName, L"", L"", 3000); }
BDAQINL ErrorCode         PwMeterCtrl_LoginEx(PwMeterCtrl *obj, wchar_t const *srvName, wchar_t const *account, wchar_t const *password, int32 timeout) { return DAQFN_ETTTT(DNLAPI_BASE, 152, wchar_t const *, wchar_t const *, wchar_t const *, int32)(obj, srvName, account, password, timeout); }
BDAQINL ErrorCode         PwMeterCtrl_Logout(PwMeterCtrl *obj)                                                                                          { return DAQFN_EV(DNLAPI_BASE, 153)(obj);                                                                                              }
...
BDAQINL Trigger*          BufferedPwMeterCtrl_getTrigger(BufferedPwMeterCtrl *obj, int32 trigger)                                      { return DAQFN_TT(DNLAPI_CNTR,  151, Trigger *, int32)(obj, trigger); }
...
BDAQINL ErrorCode         BufferedPwMeterCtrl_setSampleClkRate(BufferedPwMeterCtrl *obj, double rate)                                  { return DAQFN_ET(DNLAPI_CNTR,  268, double)(obj, rate);        }
BDAQINL double            BufferedPwMeterCtrl_getSampleClkRate(BufferedPwMeterCtrl *obj)                                               { return DAQFN_TV(DNLAPI_CNTR,  269, double)(obj);              }
...
BDAQINL ErrorCode         BufferedPwMeterCtrl_Login(BufferedPwMeterCtrl *obj, wchar_t const *srvName)                                                                   { return DAQFN_ETTTT(DNLAPI_BASE, 152, wchar_t const *, wchar_t const *, wchar_t const *, int32)(obj, srvName, L"", L"", 3000); }
BDAQINL ErrorCode         BufferedPwMeterCtrl_LoginEx(BufferedPwMeterCtrl *obj, wchar_t const *srvName, wchar_t const *account, wchar_t const *password, int32 timeout) { return DAQFN_ETTTT(DNLAPI_BASE, 152, wchar_t const *, wchar_t const *, wchar_t const *, int32)(obj, srvName, account, password, timeout); }
BDAQINL ErrorCode         BufferedPwMeterCtrl_Logout(BufferedPwMeterCtrl *obj)                                                                                          { return DAQFN_EV(DNLAPI_BASE, 153)(obj);                                                                                              }
...
BDAQINL ErrorCode         PwModulatorCtrl_Login(PwModulatorCtrl *obj, wchar_t const *srvName)                                                                 { return DAQFN_ETTTT(DNLAPI_BASE, 152, wchar_t const *, wchar_t const *, wchar_t const *, int32)(obj, srvName, L"", L"", 3000); }
BDAQINL ErrorCode         PwModulatorCtrl_LoginEx(PwModulatorCtrl *obj, wchar_t const *srvName, wchar_t const *account, wchar_t const *password, int32 timeout) { return DAQFN_ETTTT(DNLAPI_BASE, 152, wchar_t const *, wchar_t const *, wchar_t const *, int32)(obj, srvName, account, password, timeout); }
BDAQINL ErrorCode         PwModulatorCtrl_Logout(PwModulatorCtrl *obj)                                                                                        { return DAQFN_EV(DNLAPI_BASE, 153)(obj);                                                                                              }
...
BDAQINL Trigger*          BufferedPwModulatorCtrl_getTrigger(BufferedPwModulatorCtrl *obj, int32 trigger)                                { return DAQFN_TT(DNLAPI_CNTR,  171, Trigger *, int32)(obj, trigger); }
...
BDAQINL ErrorCode         BufferedPwModulatorCtrl_setSampleClkRate(BufferedPwModulatorCtrl *obj, double rate)                            { return DAQFN_ET(DNLAPI_CNTR,  272, double)(obj, rate);        }
BDAQINL double            BufferedPwModulatorCtrl_getSampleClkRate(BufferedPwModulatorCtrl *obj)                                         { return DAQFN_TV(DNLAPI_CNTR,  273, double)(obj);              }
...
BDAQINL ErrorCode         BufferedPwModulatorCtrl_Login(BufferedPwModulatorCtrl *obj, wchar_t const *srvName)                                                                 { return DAQFN_ETTTT(DNLAPI_BASE, 152, wchar_t const *, wchar_t const *, wchar_t const *, int32)(obj, srvName, L"", L"", 3000); }
BDAQINL ErrorCode         BufferedPwModulatorCtrl_LoginEx(BufferedPwModulatorCtrl *obj, wchar_t const *srvName, wchar_t const *account, wchar_t const *password, int32 timeout) { return DAQFN_ETTTT(DNLAPI_BASE, 152, wchar_t const *, wchar_t const *, wchar_t const *, int32)(obj, srvName, account, password, timeout); }
BDAQINL ErrorCode         BufferedPwModulatorCtrl_Logout(BufferedPwModulatorCtrl *obj)                                                                                        { return DAQFN_EV(DNLAPI_BASE, 153)(obj);                                                                                              }
...
BDAQINL ErrorCode         UdCounterCtrl_Login(UdCounterCtrl *obj, wchar_t const *srvName)                                                                 { return DAQFN_ETTTT(DNLAPI_BASE, 152, wchar_t const *, wchar_t const *, wchar_t const *, int32)(obj, srvName, L"", L"", 3000); }
BDAQINL ErrorCode         UdCounterCtrl_LoginEx(UdCounterCtrl *obj, wchar_t const *srvName, wchar_t const *account, wchar_t const *password, int32 timeout) { return DAQFN_ETTTT(DNLAPI_BASE, 152, wchar_t const *, wchar_t const *, wchar_t const *, int32)(obj, srvName, account, password, timeout); }
BDAQINL ErrorCode         UdCounterCtrl_Logout(UdCounterCtrl *obj)                                                                                        { return DAQFN_EV(DNLAPI_BASE, 153)(obj);                                                                                              }
...
BDAQINL Trigger*          BufferedUdCounterCtrl_getTrigger(BufferedUdCounterCtrl *obj, int32 trigger)                                   { return DAQFN_TT(DNLAPI_CNTR,  161, Trigger *, int32)(obj, trigger); }
...
BDAQINL ErrorCode         BufferedUdCounterCtrl_setSampleClkRate(BufferedUdCounterCtrl *obj, double rate)                               { return DAQFN_ET(DNLAPI_CNTR,  270, double)(obj, rate);        }
BDAQINL double            BufferedUdCounterCtrl_getSampleClkRate(BufferedUdCounterCtrl *obj)                                            { return DAQFN_TV(DNLAPI_CNTR,  271, double)(obj);              }
...
BDAQINL ErrorCode         BufferedUdCounterCtrl_Login(BufferedUdCounterCtrl *obj, wchar_t const *srvName)                                                                 { return DAQFN_ETTTT(DNLAPI_BASE, 152, wchar_t const *, wchar_t const *, wchar_t const *, int32)(obj, srvName, L"", L"", 3000); }
BDAQINL ErrorCode         BufferedUdCounterCtrl_LoginEx(BufferedUdCounterCtrl *obj, wchar_t const *srvName, wchar_t const *account, wchar_t const *password, int32 timeout) { return DAQFN_ETTTT(DNLAPI_BASE, 152, wchar_t const *, wchar_t const *, wchar_t const *, int32)(obj, srvName, account, password, timeout); }
BDAQINL ErrorCode         BufferedUdCounterCtrl_Logout(BufferedUdCounterCtrl *obj)                                                                                        { return DAQFN_EV(DNLAPI_BASE, 153)(obj);                                                                                              }
...
BDAQINL ErrorCode         AbsCounterCtrl_Login(AbsCounterCtrl *obj, wchar_t const *srvName)                                                                 { return DAQFN_ETTTT(DNLAPI_BASE, 152, wchar_t const *, wchar_t const *, wchar_t const *, int32)(obj, srvName, L"", L"", 3000); }
BDAQINL ErrorCode         AbsCounterCtrl_LoginEx(AbsCounterCtrl *obj, wchar_t const *srvName, wchar_t const *account, wchar_t const *password, int32 timeout) { return DAQFN_ETTTT(DNLAPI_BASE, 152, wchar_t const *, wchar_t const *, wchar_t const *, int32)(obj, srvName, account, password, timeout); }
BDAQINL ErrorCode         AbsCounterCtrl_Logout(AbsCounterCtrl *obj)                                                                                        { return DAQFN_EV(DNLAPI_BASE, 153)(obj);                                                                                              }
...
BDAQINL ErrorCode              EdgeSeparationCtrl_Login(EdgeSeparationCtrl *obj, wchar_t const *srvName)                                 { return DAQFN_ETTTT(DNLAPI_BASE, 152, wchar_t const *, wchar_t const *, wchar_t const *, int32)(obj, srvName, L"", L"", 3000); }
BDAQINL ErrorCode              EdgeSeparationCtrl_LoginEx(EdgeSeparationCtrl *obj, wchar_t const *srvName, wchar_t const *account, wchar_t const *password, int32 timeout) { return DAQFN_ETTTT(DNLAPI_BASE, 152, wchar_t const *, wchar_t const *, wchar_t const *, int32)(obj, srvName, account, password, timeout); }
BDAQINL ErrorCode              EdgeSeparationCtrl_Logout(EdgeSeparationCtrl *obj)                                                       { return DAQFN_EV(DNLAPI_BASE, 153)(obj);                                                                                              }
...
/* CaliSectionInParam                                        */
/* ----------------------------------------------------------*/
BDAQINL wchar_t const *       CaliSectionInParam_getTypeName(CaliSectionInParam *obj)                                                   { return DAQFN_TV(DNLAPI_BASE, 164, wchar_t const *)(obj);       }
BDAQINL wchar_t const *       CaliSectionInParam_getCaption(CaliSectionInParam *obj)                                                    { return DAQFN_TV(DNLAPI_BASE, 165, wchar_t const *)(obj);       }
BDAQINL wchar_t const *       CaliSectionInParam_getDescription(CaliSectionInParam *obj)                                                { return DAQFN_TV(DNLAPI_BASE, 166, wchar_t const *)(obj);       }
BDAQINL wchar_t const *       CaliSectionInParam_getDataEnum(CaliSectionInParam *obj)                                                   { return DAQFN_TV(DNLAPI_BASE, 167, wchar_t const *)(obj);       }
BDAQINL wchar_t const *       CaliSectionInParam_getDataType(CaliSectionInParam *obj)                                                   { return DAQFN_TV(DNLAPI_BASE, 168, wchar_t const *)(obj);       }
BDAQINL wchar_t const *       CaliSectionInParam_getSuffix(CaliSectionInParam *obj)                                                     { return DAQFN_TV(DNLAPI_BASE, 169, wchar_t const *)(obj);       }
BDAQINL wchar_t const *       CaliSectionInParam_getValue(CaliSectionInParam *obj)                                                      { return DAQFN_TV(DNLAPI_BASE, 170, wchar_t const *)(obj);       }
BDAQINL ErrorCode             CaliSectionInParam_setValue(CaliSectionInParam *obj, const wchar_t * value)                               { return DAQFN_ET(DNLAPI_BASE, 171,const wchar_t *)(obj, value); }
...
//new: add for sensor parameters
BDAQINL int8                   CaliSection_getInParamsChanged(CaliSection *obj)                                                         { return DAQFN_TV(DNLAPI_BASE, 161, int8)(obj);           }
BDAQINL int                    CaliSection_getInParamsCount(CaliSection *obj)                                                           { return DAQFN_TV(DNLAPI_BASE, 162, int)(obj);            }
BDAQINL IArray *               CaliSection_getInParams(CaliSection *obj)                                                                { return DAQFN_TV(DNLAPI_BASE, 163, IArray *)(obj);       }
...
BDAQINL ErrorCode              CalibrationCtrl_Login(CalibrationCtrl *obj, wchar_t const *srvName)                                                                 { return DAQFN_ETTTT(DNLAPI_BASE, 152, wchar_t const *, wchar_t const *, wchar_t const *, int32)(obj, srvName, L"", L"", 3000); }
BDAQINL ErrorCode              CalibrationCtrl_LoginEx(CalibrationCtrl *obj, wchar_t const *srvName, wchar_t const *account, wchar_t const *password, int32 timeout) { return DAQFN_ETTTT(DNLAPI_BASE, 152, wchar_t const *, wchar_t const *, wchar_t const *, int32)(obj, srvName, account, password, timeout); }
BDAQINL ErrorCode              CalibrationCtrl_Logout(CalibrationCtrl *obj)                                                                                        { return DAQFN_EV(DNLAPI_BASE, 153)(obj);                                                                                              }
...
BDAQINL ErrorCode              FirmwareCtrls_Login(FirmwareCtrls *obj, wchar_t const *srvName)                                                                 { return DAQFN_ETTTT(DNLAPI_BASE, 152, wchar_t const *, wchar_t const *, wchar_t const *, int32)(obj, srvName, L"", L"", 3000); }
BDAQINL ErrorCode              FirmwareCtrls_LoginEx(FirmwareCtrls *obj, wchar_t const *srvName, wchar_t const *account, wchar_t const *password, int32 timeout) { return DAQFN_ETTTT(DNLAPI_BASE, 152, wchar_t const *, wchar_t const *, wchar_t const *, int32)(obj, srvName, account, password, timeout); }
BDAQINL ErrorCode              FirmwareCtrls_Logout(FirmwareCtrls *obj)                                                                                        { return DAQFN_EV(DNLAPI_BASE, 153)(obj);                                                                                              }
...
public:
   ...
   // new: iDAQ led control
   ErrorCode          getLEDConfig(int32 length, uint8 cfg[])                              { return DeviceCtrl_getLEDConfig(this, length, cfg); }
   ErrorCode          setLEDConfig(int32 length, uint8 cfg[])                              { return DeviceCtrl_setLEDConfig(this, length, cfg); }
   ErrorCode          getLEDOutput(int32 length, uint8 sta[])                              { return DeviceCtrl_getLEDOutput(this, length, sta); }
   ErrorCode          setLEDOutPut(int32 length, uint8 sta[])                              { return DeviceCtrl_setLEDOutput(this, length, sta); }
...
public:
   ...
   static DeviceCtrl * Create(int32 devNumber, wchar_t const *desc, AccessMode mode, wchar_t const *srvName, wchar_t const *account, wchar_t const *password, int32 timeout = 3000) { return DeviceCtrl_CreateEx(devNumber, desc, mode, srvName, account, password, timeout); }
...
public:
   ...
   ErrorCode    Login(wchar_t const * srvName, int32 timeout = 3000)                                                    { return DAQFN_ETTTT(DNLAPI_BASE, 152, wchar_t const *, wchar_t const *, wchar_t const *, int32)(this, srvName, L"", L"", timeout); }
   ErrorCode    Login(wchar_t const * srvName, wchar_t const * account, wchar_t const * password, int32 timeout = 3000) { return DAQFN_ETTTT(DNLAPI_BASE, 152, wchar_t const *, wchar_t const *, wchar_t const *, int32)(this, srvName, account, password, timeout); }
   void         getEthdaqEdge(int32 size, wchar_t* srvName)                                                             { DAQFN_VTT(DNLAPI_BASE, 155, int32, wchar_t*)(this, size, srvName); }
   ErrorCode    Logout()                                                                                                { return DAQFN_EV(DNLAPI_BASE, 153)(this); }

   // Event Monitor Thread Priority Management
   int32        AdjustPriority(int32 priority)                                                                  { return DaqCtrlBase_AdjustPriority(this, priority); }
   ...
   /*New: methods for property read/write directly.*/
   ErrorCode   ReadProperty(int32 id, int32 &size, void *buffer)                                                { return DaqCtrlBase_ReadProperty(this, id, &size, buffer); }
   ErrorCode   WriteProperty(int32 id, int32 size, void *buffer)                                                { return DaqCtrlBase_WriteProperty(this, id, size, buffer); }
...
public:
   ...
   ErrorCode         runSensorCalibration(int32 ch, CalibrationData *data)          { return DAQFN_ETT(DNLAPI_AI, 111, int32, CalibrationData *)(this, ch, data); }
   ErrorCode         getChannelState(int32 count, int32 state[])                    { return DAQFN_ETT(DNLAPI_AI, 123, int32, int32 *)(this, count, state);       }
...
public:
   ...
   ErrorCode   ReadAny(int32 chStart, int32 chCount, void *dataRaw, double *dataScaled, double *timestamp)   { return InstantAiCtrl_ReadAnyWithTimestamp(this, chStart, chCount, dataRaw, dataScaled, timestamp); }
...
public: /*helpers*/
   ...
   ErrorCode   Read(int32 chStart, int32 chCount, double dataScaled[], double *timestamp)                    { return ReadAny(chStart, chCount, NULL, dataScaled, timestamp);    }
   ErrorCode   Read(int32 chStart, int32 chCount, int16 dataRaw[], double dataScaled[], double *timestamp)   { return ReadAny(chStart, chCount, dataRaw, dataScaled, timestamp); }
   ErrorCode   Read(int32 chStart, int32 chCount, int32 dataRaw[], double dataScaled[], double *timestamp)   { return ReadAny(chStart, chCount, dataRaw, dataScaled, timestamp); }
...
public:
   ...
   ErrorCode GetSliceData(void *buf, int32 timeout = 0, int32 *fetched = NULL, double *startTime = NULL, DsSignal *dsSignal = NULL, void *stream = NULL)
   {
      return WaveformAiCtrl_GetSliceData(this, buf, timeout, fetched, startTime, dsSignal, stream);
   }
   ...
   BufDataTransType   getDtcTransType()                                                        { return WaveformAiCtrl_getDtcTransType(this);          }
   ErrorCode          setDtcTransType(BufDataTransType type)                                   { return WaveformAiCtrl_setDtcTransType(this, type);    }
   DsProcessedType    getConvDataType()                                                        { return WaveformAiCtrl_getConvDataType(this);          }
   ErrorCode          setConvDataType(DsProcessedType type)                                    { return WaveformAiCtrl_setConvDataType(this, type);    }
   DsDataPermutation  getConvPermutation()                                                     { return WaveformAiCtrl_getConvPermutation(this);       }
   ErrorCode          setConvPermutation(DsDataPermutation type)                               { return WaveformAiCtrl_setConvPermutation(this, type); }
...
public:
   ...
   /*DO port property*/
   uint8         getDoPresetValue()                                        { return DioPort_getDoPresetValue(this);        }
   ErrorCode     setDoPresetValue(uint8 value)                             { return DioPort_setDoPresetValue(this, value); }
...
public:
   ...
   ErrorCode ReadAny(int32 portStart, int32 portCount, uint8 data[], double *timestamp) { return InstantDiCtrl_ReadAnyWithTimestamp(this, portStart, portCount, data, timestamp); }
   ErrorCode ReadBit(int32 port, int32 bit, uint8* data, double *timestamp)             { return InstantDiCtrl_ReadBitWithTimestamp(this, port, bit, data, timestamp);            }
   ErrorCode SnapStart()                                                                { return InstantDiCtrl_SnapStart(this);  }
   ErrorCode SnapStop()                                                                 { return InstantDiCtrl_SnapStop(this);   }

   // New SnapStart method: specify the ports to be snapped
   ErrorCode SnapStartEx(int32 portStart, int32 portCount)                              { return InstantDiCtrl_SnapStartEx(this, portStart, portCount); }
...
public: /*helpers*/
   ...
   ErrorCode Read(int32 port, uint8 & data, double *timestamp)                          { return ReadAny(port, 1, &data, timestamp);   }
   ErrorCode Read(int32 portStart, int32 portCount, uint8 data[], double *timestamp)    { return ReadAny(portStart, portCount, data, timestamp);   }
...
public:
   ...
   Array<SignalDrop>*     getTriggerSources(int32 trigger = 0)                 { return (Array<SignalDrop>*)CntrFeatures_getTriggerSources(this, trigger);   }
   Array<TriggerAction>*  getTriggerActions(int32 trigger = 0)                 { return (Array<TriggerAction>*)CntrFeatures_getTriggerActions(this, trigger);}
   void                   getTriggerDelayRange(int32 trigger, MathInterval &x) {        CntrFeatures_getTriggerDelayRange(this, trigger, &x);                }
   ...
   void                       getSampleClockRange(MathInterval &x)   {        CntrFeatures_getSampleClockRange(this, &x);                            }
...
public:
   ...
   Trigger*       getTrigger(int32 trigger = 0)            { return BufferedEventCounterCtrl_getTrigger(this, trigger);              }
   ...
   ErrorCode      setSampleClkRate(double rate)            { return BufferedEventCounterCtrl_setSampleClkRate(this, rate);  }
   double         getSampleClkRate()                       { return BufferedEventCounterCtrl_getSampleClkRate(this);        }
...
public:
   ...
   Trigger*       getTrigger(int32 trigger = 0)            { return BufferedPwMeterCtrl_getTrigger(this, trigger);     }
   ...
   ErrorCode      setSampleClkRate(double rate)            { return BufferedPwMeterCtrl_setSampleClkRate(this, rate);  }
   double         getSampleClkRate()                       { return BufferedPwMeterCtrl_getSampleClkRate(this);        }
...
public:
   ...
   Trigger*       getTrigger(int32 trigger = 0)            { return BufferedPwModulatorCtrl_getTrigger(this, trigger);     }
   ...
   ErrorCode      setSampleClkRate(double rate)            { return BufferedPwModulatorCtrl_setSampleClkRate(this, rate);  }
   double         getSampleClkRate()                       { return BufferedPwModulatorCtrl_getSampleClkRate(this);        }
...
public:
   ...
   Trigger*       getTrigger(int32 trigger = 0)            { return BufferedUdCounterCtrl_getTrigger(this, trigger);     }
   ...
   ErrorCode      setSampleClkRate(double rate)            { return BufferedUdCounterCtrl_setSampleClkRate(this, rate);  }
   double         getSampleClkRate()                       { return BufferedUdCounterCtrl_getSampleClkRate(this);        }
...
/* Interface CaliSectionInParam */ 
class CaliSectionInParam 
{ 
public: 
   wchar_t const * getTypeName(void)                                           { return CaliSectionInParam_getTypeName(this);                        } 
   wchar_t const * getCaption(void)                                            { return CaliSectionInParam_getCaption(this);                         } 
   wchar_t const * getDescription(void)                                        { return CaliSectionInParam_getDescription(this);                     } 
   wchar_t const * getDataEnum(void)                                           { return CaliSectionInParam_getDataEnum(this);                        } 
   wchar_t const * getDataType(void)                                           { return CaliSectionInParam_getDataType(this);                        } 
   wchar_t const * getSuffix(void)                                             { return CaliSectionInParam_getSuffix(this);                          } 
   wchar_t const * getValue(void)                                              { return CaliSectionInParam_getValue(this);                           } 
   ErrorCode       setValue(const wchar_t* value)                              { return CaliSectionInParam_setValue(this, value);                    }

private: 
   DAQCLS_DISABLE_CONSTRUCT(CaliSectionInParam) 
}; 
...
public:
   ...
   //new: add for sensor parameters
   bool                                getInParamsChanged(void)    { return !!CaliSection_getInParamsChanged(this);                    }
   int                                 getInParamsCount(void)      { return CaliSection_getInParamsCount(this);                        }
   Array<CaliSectionInParam>*          getInParams(void)           { return (Array<CaliSectionInParam>*)CaliSection_getInParams(this); }
